...
// Defines the possible approval status filters supported by this route.
type CommentStatus = "all" | "approved" | "pending";

// Defines the MongoDB filter structure used by the comments query.
...
export async function GET(req: NextRequest) {
  try {
    ...
    const commentStatus = status as CommentStatus;
