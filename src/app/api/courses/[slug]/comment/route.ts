...
// Defines the structure of the comment request body.
interface CreateCommentRequestBody {
  text?: unknown;
}

interface CourseCommentRouteContext {
  params: Promise<{
    slug: string;
  }>;
}
...
export async function POST(
  req: NextRequest,
  { params }: CourseCommentRouteContext,
  ...
  try {
    ...
    const { text } = (await req.json()) as CreateCommentRequestBody;
