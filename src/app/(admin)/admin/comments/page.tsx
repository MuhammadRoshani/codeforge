...
export default function Comments() {
  ...
  const [replyingToComment, setReplyingToComment] =
    useState<AdminComment | null>(null);
  ...
  const openReplyModal = (comment: AdminComment) => {
  ...
  const handleAdminReply = async () => {
    ...
    try {
      ...
      const { data } = await api.post<CommentActionResponse>(
  ...
  const handleEditReply = async () => {
    ...
    try {
      ...
      const { data } = await api.patch<CommentActionResponse>(
  ...
  const handleDelete = async (commentId: string) => {
    ...
    try {
      const { data } = await api.delete<CommentActionResponse>(
