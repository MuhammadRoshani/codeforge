...
// Defines the props required by the OTP input component.
interface OtpInputsProps {
  otp: string[];
  setOtp: React.Dispatch<React.SetStateAction<string[]>>;
}

export default function OtpInputs({ otp, setOtp }: OtpInputsProps) {
